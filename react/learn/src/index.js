...
// 2.异常处理添加ComponentDidCatch钩子（函数） 获取组件错误
...
//ReactDOM.render(<PureComponentTest body = 'vue is very good' author = 'liuyuxi' />, document.querySelector('#root'))
