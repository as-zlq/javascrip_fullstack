...
class KFormSample extends Component {
    ...
    render() {
        const {getFieldDec,isFieldTouch,getFieldError} = this.props
        const userNameError = isFieldTouch('uname')&& getFieldError('uname')
        const passwordError = isFieldTouch('pwd')&& getFieldError('pwd')
